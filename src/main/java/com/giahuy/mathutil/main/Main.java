...
import com.giahuy.mathutil.core.MathUtility;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        long actual = MathUtility.getFactorial(n); // thực tế là mấy, gọi hàm là biết liền
...
// DÂN DEVELOPER VIẾT CODE THÌ PHẢI CÓ TRÁCH NHIỆM TEST CODE CỦA MÌNH
// VIẾT CODE: HÀM, CLASS
// LÀM SAO TEST CODE CỦA CHÍNH MÌNH
// CÓ 3 CÁCH
// CÁCH 1: IN RA MÀN HÌNH KẾT QUẢ XỬ LÝ CỦA MÌNH

// CÁCH 2: IN RA LOG FILE

// CÁCH 3: (XỊN NHẤT) DÙNG ĐỒ CHƠI BÊN NGOÀI MANG VÀO - THƯ VIỆN ĐEM VÀO
...
//                KÈM THÊM EXPECTED VALUE ĐỂ XEM APP TRẢ VỀ GIỐNG HOK
...
// Test case là một tình huống xài app với bộ data đưa vào và giá trị kì vọng phải trả về
...
//STATUS: PASSED | FAILED, just waiting the medthod returns value
//                          ĐOÁN XEM!!!
